...
export interface IE2EScenarioSynthesizer {
    ...
    getAvailableTargetNames(options: AnyOptions & {
 ...
 * ```
 */
export type ReferenceFilterCallback = (edge: IHeapEdge, snapshot: IHeapSnapshot, isReferenceUsedByDefault: boolean) => boolean;
/**
