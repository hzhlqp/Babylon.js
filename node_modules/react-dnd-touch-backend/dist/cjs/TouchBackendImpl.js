...
const supportsPassive_1 = require("./utils/supportsPassive");
const OptionsReader_1 = require("./OptionsReader");
const eventNames = {
    [interfaces_1.ListenerType.mouse]: {
        start: 'mousedown',
        move: 'mousemove',
        end: 'mouseup',
        contextmenu: 'contextmenu',
    },
    [interfaces_1.ListenerType.touch]: {
        start: 'touchstart',
        move: 'touchmove',
        end: 'touchend',
    },
    [interfaces_1.ListenerType.keyboard]: {
        keydown: 'keydown',
    },
};
class TouchBackendImpl {
    ...
    setup() {
        ...
        (0, invariant_1.invariant)(!TouchBackendImpl.isSetUp, 'Cannot have two Touch backends at the same time.');
    ...
    addEventListener(subject, event, handler, capture = false) {
        const options = supportsPassive_1.supportsPassive ? { capture, passive: false } : capture;
    ...
    getSourceClientOffset = (sourceId) => {
        ...
        return element && (0, offsets_1.getNodeClientOffset)(element);
    };
    handleTopMoveStartCapture = (e) => {
        if (!(0, predicates_1.eventShouldStartDrag)(e)) {
            return;
        }
    ...
    handleTopMoveStart = (e) => {
        ...
        const clientOffset = (0, offsets_1.getEventClientOffset)(e);
        if (clientOffset) {
    ...
    handleTopMove = (e) => {
        ...
        const clientOffset = (0, offsets_1.getEventClientOffset)(e, this.lastTargetTouchFallback);
        if (!clientOffset) {
            return;
        }
        ...
        if (this._isScrolling ||
            (!this.monitor.isDragging() &&
                (0, math_1.inAngleRanges)(this._mouseClientOffset.x || 0, this._mouseClientOffset.y || 0, clientOffset.x, clientOffset.y, this.options.scrollAngleRanges))) {
        ...
        if (!this.monitor.isDragging() &&
            ...
            moveStartSourceIds &&
            (0, math_1.distance)(this._mouseClientOffset.x || 0, this._mouseClientOffset.y || 0, clientOffset.x, clientOffset.y) > (this.options.touchSlop ? this.options.touchSlop : 0)) {
    ...
    handleTopMoveEndCapture = (e) => {
        ...
        if (!(0, predicates_1.eventShouldEndDrag)(e)) {
            return;
        }
