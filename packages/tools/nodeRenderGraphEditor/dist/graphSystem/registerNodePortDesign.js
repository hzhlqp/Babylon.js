...
export const RegisterNodePortDesign = (stateManager) => {
    stateManager.applyNodePortDesign = (portData, element, img, _pip) => {
        const connectionPortData = portData;
...
//# sourceMappingURL=registerNodePortDesign.js.map