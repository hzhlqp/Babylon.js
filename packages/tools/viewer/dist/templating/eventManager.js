...
export class EventManager {
     ...
     */
    registerCallback(templateName, callback, eventType, selector) {
     ...
     */
    unregisterCallback(templateName, callback, eventType, selector) {
