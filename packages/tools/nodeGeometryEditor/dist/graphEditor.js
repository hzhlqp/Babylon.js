...
export class GraphEditor extends React.Component {
    appendBlock(dataToAppend, recursion = true) {
        return this._graphCanvas.createNodeFromObject(dataToAppend instanceof NodeGeometryBlock ? TypeLedger.NodeDataBuilder(dataToAppend, this._graphCanvas) : dataToAppend, (block) => {
    ...
    constructor(props) {
        ...
        this.props.globalState.onImportFrameObservable.add((source) => {
            ...
            this.props.globalState.nodeGeometry.attachedBlocks.slice(-frameData.blocks.length).forEach((block) => {
        ...
        this.props.globalState.hostDocument.addEventListener("keydown", (evt) => {
            ...
            this._graphCanvas.handleKeyDown(evt, (nodeData) => {
                this.props.globalState.nodeGeometry.removeBlock(nodeData.data);
    ...
    loadGraph() {
        ...
        geometry.attachedBlocks.forEach((n) => {
    ...
    resizeColumns(evt, forLeft = true) {
        ...
        const rootElement = evt.currentTarget.ownerDocument.getElementById("node-geometry-editor-graph-root");
        if (forLeft) {
    ...
    render() {
        return (_jsxs(Portal, { globalState: this.props.globalState, children: [_jsxs("div", { id: "node-geometry-editor-graph-root", style: {
                        ...
                        this.props.globalState.lockObject.lock = false;
                                ...
                                } }) }), _jsx("div", { id: "rightGrab", onPointerDown: (evt) => this.onPointerDown(evt), onPointerUp: (evt) => this.onPointerUp(evt), onPointerMove: (evt) => this.resizeColumns(evt, false) }), _jsxs("div", { className: "nge-right-panel", children: [_jsx(PropertyTabComponent, { lockObject: this.props.globalState.lockObject, globalState: this.props.globalState }), !this.state.showPreviewPopUp ? _jsx(PreviewMeshControlComponent, { globalState: this.props.globalState, togglePreviewAreaComponent: this.handlePopUp }) : null, !this.state.showPreviewPopUp ? _jsx(PreviewAreaComponent, { globalState: this.props.globalState, width: this._rightWidth }) : null] }), _jsx(LogComponent, { globalState: this.props.globalState })] }), _jsx(MessageDialog, { message: this.state.message, isError: this.state.isError, onClose: () => this.setState({ message: "" }) }), _jsx("div", { className: "blocker", children: "Node Geometry Editor runs only on desktop" }), _jsx("div", { className: "wait-screen hidden", children: "Processing...please wait" })] }));
    }
}
