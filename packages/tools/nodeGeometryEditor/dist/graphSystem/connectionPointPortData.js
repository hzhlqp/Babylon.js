...
export class ConnectionPointPortData {
    ...
    get direction() {
        switch (this.data.direction) {
            case 0 /* NodeGeometryConnectionPointDirection.Input */:
    ...
    checkCompatibilityState(port) {
        ...
        switch (state) {
            case 0 /* NodeGeometryConnectionPointCompatibilityStates.Compatible */:
                return 0;
            default:
                return state;
        }
    ...
    getCompatibilityIssueMessage(issue, targetNode, targetPort) {
        switch (issue) {
            case 1 /* NodeGeometryConnectionPointCompatibilityStates.TypeIncompatible */:
                return "Cannot connect two different connection types";
            case 2 /* NodeGeometryConnectionPointCompatibilityStates.HierarchyIssue */:
