...
export class PreviewManager {
    constructor(targetCanvas, globalState) {
        ...
        // Axis
        const generateTextPlane = function (text, color, size, scene, parent) {
        ...
        this._axis.xAxis.getChildMeshes()[0].material.emissiveColor.scaleInPlace(2);
        this._axis.yAxis.getChildMeshes()[0].material.emissiveColor.scaleInPlace(2);
        this._axis.zAxis.getChildMeshes()[0].material.emissiveColor.scaleInPlace(2);
