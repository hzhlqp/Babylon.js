...
export class NodeListComponent extends React.Component {
    ...
    render() {
        ...
        for (const key in allBlocks) {
            const blockList = allBlocks[key]
                ...
                if (key === "Custom_Frames") {
                    return (_jsx(DraggableLineWithButtonComponent, { format: "babylonjs-geometry-node", data: block, tooltip: this._customFrameList[block] || "", iconImage: deleteButton, iconTitle: "Delete", onIconClick: (value) => this.removeItem(value) }, block));
                }
                return _jsx(DraggableLineComponent, { format: "babylonjs-geometry-node", data: block, tooltip: NodeListComponent._Tooltips[block] || "" }, block);
            });
            if (key === "Custom_Frames") {
        ...
        return (_jsx("div", { id: "ngeNodeList", children: _jsx("div", { className: "panes", children: _jsxs("div", { className: "pane", children: [_jsx("div", { className: "filter", children: _jsx("input", { type: "text", placeholder: "Filter", onFocus: () => (this.props.globalState.lockObject.lock = true), onBlur: () => {
