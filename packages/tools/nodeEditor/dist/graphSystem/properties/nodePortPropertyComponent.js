...
export class NodePortPropertyTabComponent extends React.Component {
    ...
    render() {
        ...
        return (_jsxs("div", { id: "propertyTab", children: [_jsxs("div", { id: "header", children: [_jsx("img", { id: "logo", src: "https://www.babylonjs.com/Assets/logo-babylonjs-social-twitter.png" }), _jsx("div", { id: "title", children: "NODE MATERIAL EDITOR" })] }), _jsx("div", { children: _jsx(LineContainerComponent, { title: "GENERAL", children: info }) })] }));
    }
}
