...
export class PreviewMeshControlComponent extends React.Component {
    ...
    render() {
        ...
        const options = this.props.globalState.mode === NodeMaterialModes.Particle
            ? particleTypeOptions
        ...
        return (_jsxs("div", { id: "preview-mesh-bar", children: [(this.props.globalState.mode === NodeMaterialModes.Material ||
                    this.props.globalState.mode === NodeMaterialModes.Particle ||
                    this.props.globalState.mode === NodeMaterialModes.GaussianSplatting) && (_jsxs(_Fragment, { children: [_jsx(OptionsLine, { label: "", options: options, target: this.props.globalState, propertyName: "previewType", noDirectUpdate: true, onSelect: (value) => {
