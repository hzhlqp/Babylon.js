...
export class PropertyTabComponent extends React.Component {
    ...
    render() {
        if (this.state.currentNode) {
            return (_jsxs("div", { id: "propertyTab", children: [_jsxs("div", { id: "header", children: [_jsx("img", { id: "logo", src: "https://www.babylonjs.com/Assets/logo-babylonjs-social-twitter.png" }), _jsx("div", { id: "title", children: "NODE MATERIAL EDITOR" })] }), this.state.currentNode?.renderProperties() || this.state.currentNodePort?.node.renderProperties()] }));
        }
        ...
        return (_jsxs("div", { id: "propertyTab", children: [_jsxs("div", { id: "header", children: [_jsx("img", { id: "logo", src: "https://www.babylonjs.com/Assets/logo-babylonjs-social-twitter.png" }), _jsx("div", { id: "title", children: "NODE MATERIAL EDITOR" })] }), _jsxs("div", { children: [_jsxs(LineContainerComponent, { title: "GENERAL", children: [_jsx(OptionsLine, { ref: this._modeSelect, label: "Mode", target: this, extractValue: () => this.props.globalState.mode, options: modeList, onSelect: (value) => this.changeMode(value), propertyName: "" }), _jsx(OptionsLine, { label: "Engine", target: this, extractValue: () => this.props.globalState.engine, options: engineList, onSelect: (value) => {
                                        this.props.globalState.engine = value;
                                        this.forceUpdate();
                                    }, propertyName: "" }), _jsx(TextLineComponent, { label: "Version", value: Engine.Version }), _jsx(TextLineComponent, { label: "Help", value: "doc.babylonjs.com", underline: true, onLink: () => this.props.globalState.hostDocument.defaultView.open("https://doc.babylonjs.com/how_to/node_material", "_blank") }), _jsx(TextInputLineComponent, { label: "Comment", multilines: true, lockObject: this.props.globalState.lockObject, value: this.props.globalState.nodeMaterial.comment, target: this.props.globalState.nodeMaterial, propertyName: "comment" }), _jsx(ButtonLineComponent, { label: "Reset to default", onClick: () => {
                                    ...
                                    } })] }), _jsxs(LineContainerComponent, { title: "OPTIONS", children: [_jsx(CheckBoxLineComponent, { label: "Embed textures when saving", isSelected: () => DataStorage.ReadBoolean("EmbedTextures", true), onSelect: (value) => {
                                        DataStorage.WriteBoolean("EmbedTextures", value);
                                    } }), _jsx(SliderLineComponent, { lockObject: this.props.lockObject, label: "Grid size", minimum: 0, maximum: 100, step: 5, decimalCount: 0, directValue: gridSize, onChange: (value) => {
                                        ...
                                        this.props.globalState.stateManager.onGridSizeChanged.notifyObservers();
                                    } })] }), _jsxs(LineContainerComponent, { title: "FILE", children: [_jsx(FileButtonLine, { label: "Load", onClick: (file) => this.load(file), accept: ".json" }), _jsx(ButtonLineComponent, { label: "Save", onClick: () => {
                                        this.save();
                                    ...
                                    } }), _jsx(ButtonLineComponent, { label: "Export shaders", onClick: () => {
                                    ...
                                    } }), this.props.globalState.customSave && (_jsx(ButtonLineComponent, { label: this.props.globalState.customSave.label, isDisabled: this.state.uploadInProgress, onClick: () => {
                                        this.customSave();
                                    } })), _jsx(FileButtonLine, { label: "Load Frame", onClick: (file) => this.loadFrame(file), accept: ".json" })] }), !this.props.globalState.customSave && (_jsxs(LineContainerComponent, { title: "SNIPPET", children: [this.props.globalState.nodeMaterial.snippetId && _jsx(TextLineComponent, { label: "Snippet ID", value: this.props.globalState.nodeMaterial.snippetId }), _jsx(ButtonLineComponent, { label: "Load from snippet server", onClick: () => this.loadFromSnippet() }), _jsx(ButtonLineComponent, { label: "Save to snippet server", onClick: () => {
                                        this.saveToSnippetServer();
                                    } })] })), _jsxs(LineContainerComponent, { title: "TRANSPARENCY", children: [_jsx(CheckBoxLineComponent, { label: "Force alpha blending", target: this.props.globalState.nodeMaterial, propertyName: "forceAlphaBlending", onValueChanged: () => this.props.globalState.stateManager.onUpdateRequiredObservable.notifyObservers(null) }), _jsx(OptionsLine, { label: "Alpha mode", options: alphaModeOptions, target: this.props.globalState.nodeMaterial, propertyName: "alphaMode", onSelect: () => this.props.globalState.stateManager.onUpdateRequiredObservable.notifyObservers(null) })] }), _jsx(InputsPropertyTabComponent, { lockObject: this.props.lockObject, globalState: this.props.globalState, inputs: this.props.globalState.nodeMaterial.getInputBlocks() })] })] }));
    }
}
