...
export class CommandBarComponent extends React.Component {
    ...
    render() {
        ...
        return (_jsxs("div", { className: "ge-commands", children: [_jsxs("div", { className: "commands-left", children: [_jsxs("div", { className: "divider", children: [_jsx("img", { src: logoIcon, color: "white", className: "active", draggable: false }), _jsx(CommandDropdownComponent, { globalState: this.props.globalState, toRight: true, icon: hamburgerIcon, tooltip: "Options", items: [
                                        {
                                            label: "Save",
                                            onClick: () => {
                                    ...
                                    ] }), _jsx(CommandButtonComponent, { tooltip: "Select", icon: pointerIcon, shortcut: "S", isActive: this.props.globalState.tool === GUIEditorTool.SELECT, onClick: () => {
                                        this.props.globalState.tool = GUIEditorTool.SELECT;
                                    } }), _jsx(CommandButtonComponent, { tooltip: "Pan", icon: handIcon, shortcut: "P", isActive: this.props.globalState.tool === GUIEditorTool.PAN, onClick: () => {
                                        this.props.globalState.tool = GUIEditorTool.PAN;
                                    } }), _jsx(CommandButtonComponent, { tooltip: "Zoom", shortcut: "Z", icon: zoomIcon, isActive: this.props.globalState.tool === GUIEditorTool.ZOOM, onClick: () => {
                                        this.props.globalState.tool = GUIEditorTool.ZOOM;
                                    } })] }), _jsxs("div", { className: "divider", children: [_jsx(CommandButtonComponent, { tooltip: "Copy Selected", shortcut: "Ctrl + C", icon: copyyIcon, isActive: false, copyDeleteDisabled: this.props.globalState.selectedControls.length === 0, onClick: () => {
                                        ...
                                        this.forceUpdate();
                                    } }), _jsx(CommandButtonComponent, { tooltip: "Paste", shortcut: "Ctrl + V", icon: pasteeIcon, isActive: false, pasteDisabled: isPasteDisabled, onClick: async () => {
                                    ...
                                    } }), _jsx(CommandButtonComponent, { tooltip: "Delete", shortcut: "Delete", icon: deleteeIcon, isActive: false, copyDeleteDisabled: this.props.globalState.selectedControls.length === 0, onClick: () => {
                                    ...
                                    } })] }), _jsxs("div", { className: "divider", children: [_jsx(CommandButtonComponent, { tooltip: "Fit to Window", shortcut: "F", icon: canvasFitIcon, isActive: false, onClick: () => {
                                        this.props.globalState.onFitControlsToWindowObservable.notifyObservers();
                                    } }), _jsx(CommandButtonComponent, { tooltip: "Toggle Guides", shortcut: "G", icon: guidesIcon, isActive: this.props.globalState.outlines, onClick: () => (this.props.globalState.outlines = !this.props.globalState.outlines) })] }), _jsx("div", { className: "divider padded", children: _jsx(ColorLine, { lockObject: this._lockObject, label: "Artboard:", target: this.props.globalState, propertyName: "backgroundColor", disableAlpha: true }) }), _jsxs("div", { className: "divider padded", children: [_jsx(CheckBoxLineComponent, { label: "Responsive:", iconLabel: "Responsive GUIs will resize the UI layout and reflow controls to accommodate different device screen sizes", isSelected: () => DataStorage.ReadBoolean("Responsive", true), onSelect: (value) => {
                                        ...
                                        this.forceUpdate();
                                    }, large: true }), responsiveUI && (_jsx(OptionsLine, { label: "", iconLabel: "Size", options: _sizeOptions, target: this, propertyName: "_sizeOption", noDirectUpdate: true, onSelect: (value) => {
                                        ...
                                        this.forceUpdate();
                                    } })), !responsiveUI && (_jsxs(_Fragment, { children: [_jsx(FloatLineComponent, { lockObject: this._lockObject, label: "W", target: size, propertyName: "width", min: 1, max: MAX_TEXTURE_SIZE, onChange: (newValue) => {
                                                ...
                                                this.props.globalState.workbench.guiSize = { width: newValue, height: size.height };
                                                DataStorage.WriteNumber("width", this.props.globalState.workbench.guiSize.width);
                                            }, arrows: true, isInteger: true }), _jsx(FloatLineComponent, { lockObject: this._lockObject, label: "H", target: size, propertyName: "height", min: 1, max: MAX_TEXTURE_SIZE, onChange: (newValue) => {
                                                if (!this._stopUpdating) {
                                                ...
                                                this.props.globalState.workbench.guiSize = { width: size.width, height: newValue };
                                                DataStorage.WriteNumber("height", this.props.globalState.workbench.guiSize.width);
                                            }, arrows: true, isInteger: true })] }))] })] }), _jsx("div", { className: "commands-right" })] }));
    }
}
