...
export function GizmoLine(props) {
    ...
    return (_jsx("div", { className: "gizmo", children: scalePoints.map((point, index) => (_jsx(GizmoScalePoint, { scalePoint: point, allowClickOnPivot: true, clickable: true, onDrag: onDrag, onRotate: onRotate, onUp: onUp, canRotate: true }, index))) }));
}
//# sourceMappingURL=gizmoLine.js.map