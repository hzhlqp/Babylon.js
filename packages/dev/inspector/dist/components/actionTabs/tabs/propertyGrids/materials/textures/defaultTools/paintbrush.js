...
class Settings extends React.Component {
    render() {
        ...
        return (_jsx("div", { children: _jsxs("label", { className: "tool-slider-input", children: [_jsxs("span", { children: ["Size: ", instance.width] }), _jsx("input", { id: "contrast-slider", type: "range", min: 1, max: 100, value: instance.width, onChange: (evt) => {
