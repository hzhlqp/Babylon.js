...
export class RenderGridPropertyGridComponent extends React.Component {
    ...
    render() {
        return (_jsx("div", { children: _jsx(CheckBoxLineComponent, { label: "Render grid", isSelected: () => this.state.isEnabled, onSelect: () => this.addOrRemoveGrid() }) }));
    }
}
//# sourceMappingURL=renderGridPropertyGridComponent.js.map