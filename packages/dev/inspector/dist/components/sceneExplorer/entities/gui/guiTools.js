 ...
 */
export function InjectGUIEditor(guiEditorPackage) {
 ...
 * @param guiEditorURL
 */
export function SetGUIEditorURL(guiEditorURL) {
 ...
 */
export async function EditAdvancedDynamicTexture(adt, embed) {
...
//# sourceMappingURL=guiTools.js.map