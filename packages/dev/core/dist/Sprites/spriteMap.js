...
export class SpriteMap {
    ...
    _createTileAnimationBuffer(buffer) {
        ...
        const t = RawTexture.CreateRGBATexture(floatArray, this.spriteCount, this.options.maxAnimationFrames || 4, this._scene, false, false, Texture.NEAREST_NEAREST, Constants.TEXTURETYPE_FLOAT);
        return t;
    }
    /**
