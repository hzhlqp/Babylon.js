                ...
                if (spritePickResult.hit && spritePickResult.pickedSprite) {
                    if (spritePickResult.pickedSprite.actionManager) {
                        ...
                        if (spritePickResult.pickedSprite.actionManager) {
                            ...
                            if (doubleClick) {
                                spritePickResult.pickedSprite.actionManager.processTrigger(Constants.ACTION_OnDoublePickTrigger, ActionEvent.CreateNewFromSprite(spritePickResult.pickedSprite, scene, evt));
                            }
                        }
                    }
                }
