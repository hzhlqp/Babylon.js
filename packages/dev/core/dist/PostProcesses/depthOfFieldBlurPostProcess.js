...
export class DepthOfFieldBlurPostProcess extends BlurPostProcess {
     ...
     */
    constructor(name, _scene, direction, kernel, options, camera, circleOfConfusion, imageToBlur = null, samplingMode = Texture.BILINEAR_SAMPLINGMODE, engine, reusable, textureType = Constants.TEXTURETYPE_UNSIGNED_INT, blockCompilation = false, textureFormat = Constants.TEXTUREFORMAT_RGBA) {
