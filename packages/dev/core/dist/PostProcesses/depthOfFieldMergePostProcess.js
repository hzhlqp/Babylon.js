...
export class DepthOfFieldMergePostProcess extends PostProcess {
     ...
     */
    constructor(name, originalFromInput, circleOfConfusion, _blurSteps, options, camera, samplingMode, engine, reusable, textureType = Constants.TEXTURETYPE_UNSIGNED_INT, blockCompilation = false) {
