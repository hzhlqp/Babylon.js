...
export class ScreenSpaceReflectionPostProcess extends PostProcess {
     ...
     */
    constructor(name, scene, options, camera, samplingMode, engine, reusable, textureType = Constants.TEXTURETYPE_UNSIGNED_INT, blockCompilation = false, forceGeometryBuffer = false) {
