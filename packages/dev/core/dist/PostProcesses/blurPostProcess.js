...
export class BlurPostProcess extends PostProcess {
     ...
     */
    constructor(name, direction, kernel, options, camera = null, samplingMode = Texture.BILINEAR_SAMPLINGMODE, engine, reusable, textureType = Constants.TEXTURETYPE_UNSIGNED_INT, defines = "", blockCompilation = false, textureFormat = Constants.TEXTUREFORMAT_RGBA) {
