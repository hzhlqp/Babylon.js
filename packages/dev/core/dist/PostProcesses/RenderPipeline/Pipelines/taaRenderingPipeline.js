...
export class TAARenderingPipeline extends PostProcessRenderPipeline {
     ...
     */
    constructor(name, scene, cameras, textureType = Constants.TEXTURETYPE_UNSIGNED_BYTE) {
    ...
    _createPingPongTextures(width, height) {
        ...
        this._ping?.dispose();
        this._pong?.dispose();
        this._ping = engine.createRenderTargetTexture({ width, height }, { generateMipMaps: false, generateDepthBuffer: false, type: Constants.TEXTURETYPE_HALF_FLOAT, samplingMode: Constants.TEXTURE_NEAREST_NEAREST });
        this._pong = engine.createRenderTargetTexture({ width, height }, { generateMipMaps: false, generateDepthBuffer: false, type: Constants.TEXTURETYPE_HALF_FLOAT, samplingMode: Constants.TEXTURE_NEAREST_NEAREST });
