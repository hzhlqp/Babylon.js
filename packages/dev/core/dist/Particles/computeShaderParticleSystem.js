...
export class ComputeShaderParticleSystem {
    ...
    createParticleBuffer(data) {
        const buffer = new StorageBuffer(this._engine, data.length * 4, Constants.BUFFER_CREATIONFLAG_READWRITE | Constants.BUFFER_CREATIONFLAG_VERTEX, "ComputeShaderParticleSystemBuffer");
        buffer.update(data);
