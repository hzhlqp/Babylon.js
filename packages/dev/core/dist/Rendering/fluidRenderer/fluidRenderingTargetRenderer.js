...
export class FluidRenderingTargetRenderer {
    ...
    _initialize() {
        ...
        this._depthRenderTarget = new FluidRenderingTextures("Depth", this._scene, depthWidth, depthHeight, depthWidth, depthHeight, Constants.TEXTURETYPE_FLOAT, Constants.TEXTUREFORMAT_RG, Constants.TEXTURETYPE_FLOAT, Constants.TEXTUREFORMAT_RG, false, this._camera, true, this._samples, this._shaderLanguage);
        ...
        if (this.generateDiffuseTexture) {
            ...
            this._diffuseRenderTarget = new FluidRenderingTextures("Diffuse", this._scene, diffuseWidth, diffuseHeight, 0, 0, Constants.TEXTURETYPE_UNSIGNED_BYTE, Constants.TEXTUREFORMAT_RGBA, Constants.TEXTURETYPE_UNSIGNED_BYTE, Constants.TEXTUREFORMAT_RGBA, true, this._camera, true, this._samples, this._shaderLanguage);
        ...
        if (!this._useFixedThickness) {
            this._thicknessRenderTarget = new FluidRenderingTextures("Thickness", this._scene, thicknessWidth, thicknessHeight, thicknessWidth, thicknessHeight, Constants.TEXTURETYPE_HALF_FLOAT, Constants.TEXTUREFORMAT_R, Constants.TEXTURETYPE_HALF_FLOAT, Constants.TEXTUREFORMAT_R, true, this._camera, false, this._samples, this._shaderLanguage);
    ...
    _createLiquidRenderingPostProcess() {
        ...
        this._renderPostProcess = new PostProcess("FluidRendering", "fluidRenderingRender", uniformNames, samplerNames, 1, null, Constants.TEXTURE_BILINEAR_SAMPLINGMODE, engine, false, null, Constants.TEXTURETYPE_UNSIGNED_BYTE, undefined, undefined, true, undefined, this._shaderLanguage, async () => {
