...
export class FluidRenderingTextures {
    ...
    constructor(name, scene, width, height, blurTextureSizeX, blurTextureSizeY, textureType = Constants.TEXTURETYPE_FLOAT, textureFormat = Constants.TEXTUREFORMAT_R, blurTextureType = Constants.TEXTURETYPE_FLOAT, blurTextureFormat = Constants.TEXTUREFORMAT_R, useStandardBlur = false, camera = null, generateDepthBuffer = true, samples = 1, shaderLanguage) {
    ...
    _createBlurPostProcesses(textureBlurSource, textureType, textureFormat, blurSizeDivisor, debugName, useStandardBlur = false) {
        ...
        const useBilinearFiltering = (textureType === Constants.TEXTURETYPE_FLOAT && engine.getCaps().textureFloatLinearFiltering) ||
        ...
        if (useStandardBlur) {
            const kernelBlurXPostprocess = new PostProcess("BilateralBlurX", "fluidRenderingStandardBlur", ["filterSize", "blurDir"], null, 1, null, Constants.TEXTURE_NEAREST_SAMPLINGMODE, engine, true, null, textureType, undefined, undefined, undefined, textureFormat, this._shaderLanguage, async () => {
            ...
            const kernelBlurYPostprocess = new PostProcess("BilateralBlurY", "fluidRenderingStandardBlur", ["filterSize", "blurDir"], null, 1, null, Constants.TEXTURE_NEAREST_SAMPLINGMODE, engine, true, null, textureType, undefined, undefined, undefined, textureFormat, this._shaderLanguage, async () => {
                if (this.shaderLanguage === 1 /* ShaderLanguage.WGSL */) {
                    await import("../../ShadersWGSL/fluidRenderingStandardBlur.fragment");
                }
                else {
            ...
            const kernelBlurXPostprocess = new PostProcess("BilateralBlurX", "fluidRenderingBilateralBlur", uniforms, null, 1, null, Constants.TEXTURE_NEAREST_SAMPLINGMODE, engine, true, null, textureType, undefined, undefined, undefined, textureFormat, this._shaderLanguage, async () => {
                if (this.shaderLanguage === 1 /* ShaderLanguage.WGSL */) {
            ...
            this._fixReusablePostProcess(kernelBlurXPostprocess);
            const kernelBlurYPostprocess = new PostProcess("BilateralBlurY", "fluidRenderingBilateralBlur", uniforms, null, 1, null, Constants.TEXTURE_NEAREST_SAMPLINGMODE, engine, true, null, textureType, undefined, undefined, undefined, textureFormat, this._shaderLanguage, async () => {
                if (this.shaderLanguage === 1 /* ShaderLanguage.WGSL */) {
                    await import("../../ShadersWGSL/fluidRenderingBilateralBlur.fragment");
                }
                else {
