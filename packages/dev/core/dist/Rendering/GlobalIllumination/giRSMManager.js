...
export class GIRSMManager {
    ...
    generateSampleTexture(maxSamples) {
        ...
        this._sampleTexture = new RawTexture(data, this._maxSamples, 1, Constants.TEXTUREFORMAT_RGBA, this._scene, false, false, Constants.TEXTURE_NEAREST_SAMPLINGMODE, Constants.TEXTURETYPE_FLOAT);
     ...
     */
    constructor(scene, outputDimensions, giTextureDimensions = { width: 256, height: 256 }, maxSamples = 2048, giTextureType = Constants.TEXTURETYPE_UNSIGNED_INT_2_10_10_10_REV) {
        this._giRSM = [];
        this._blurRTT = null;
    ...
    _createPostProcesses() {
        ...
        const geometryBufferRenderer = this._scene.enableGeometryBufferRenderer(this._enableBlur ? this._outputDimensions : this._giTextureDimensions, this._use32BitsDepthBuffer ? Constants.TEXTUREFORMAT_DEPTH32_FLOAT : Constants.TEXTUREFORMAT_DEPTH16, GIRSMManager.GeometryBufferTextureTypesAndFormats);
...
GIRSMManager.GeometryBufferTextureTypesAndFormats = {
    ...
    0: { textureType: Constants.TEXTURETYPE_HALF_FLOAT, textureFormat: Constants.TEXTUREFORMAT_R },
    // eslint-disable-next-line @typescript-eslint/naming-convention
    1: { textureType: Constants.TEXTURETYPE_UNSIGNED_INT_2_10_10_10_REV, textureFormat: Constants.TEXTUREFORMAT_RGBA },
    // eslint-disable-next-line @typescript-eslint/naming-convention
