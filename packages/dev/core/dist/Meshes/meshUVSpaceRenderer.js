...
export class MeshUVSpaceRenderer {
    ...
    _createMaskTexture() {
        ...
        true, Constants.TEXTURETYPE_UNSIGNED_BYTE, false, Constants.TEXTURE_BILINEAR_SAMPLINGMODE, undefined, undefined, undefined, Constants.TEXTUREFORMAT_R);
    ...
    _createPostProcess() {
        ...
        this._finalPostProcess = new PostProcess(this._mesh.name + "_fixSeamsPostProcess", "meshUVSpaceRendererFinaliser", ["textureSize"], ["textureSampler", "maskTextureSampler"], 1.0, null, Constants.TEXTURE_NEAREST_SAMPLINGMODE, this._scene.getEngine(), false, null, this._options.textureType, undefined, undefined, undefined, undefined, this._shaderLanguage);
