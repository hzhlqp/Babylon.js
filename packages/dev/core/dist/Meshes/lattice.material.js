...
export class LatticePluginMaterial extends MaterialPluginBase {
    ...
    refreshData() {
        ...
        if (!this._latticeDataTexture ||
            ...
            this._latticeDataTexture = new RawTexture3D(this._latticeData, this._lattice.resolutionX, this._lattice.resolutionY, this._lattice.resolutionZ, Constants.TEXTUREFORMAT_RGBA, this._material.getScene(), false, false, Constants.TEXTURE_NEAREST_SAMPLINGMODE, Constants.TEXTURETYPE_FLOAT);
        }
        else {
