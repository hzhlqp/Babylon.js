...
export class Mesh extends AbstractMesh {
    ...
    _getFlattenedNormals(indices, positions) {
        ...
        const flipNormalGeneration = this.sideOrientation === (this._scene.useRightHandedSystem ? Constants.MATERIAL_CounterClockWiseSideOrientation : Constants.MATERIAL_ClockWiseSideOrientation);
