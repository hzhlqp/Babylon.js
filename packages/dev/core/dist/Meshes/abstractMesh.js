...
export class AbstractMesh extends TransformNode {
    ...
    _collideForSubMesh(subMesh, transformMatrix, collider) {
        ...
        // Collide
        collider._collide(subMesh._trianglePlanes, subMesh._lastColliderWorldVertices, this.getIndices(), subMesh.indexStart, subMesh.indexStart + subMesh.indexCount, subMesh.verticesStart, !!subMesh.getMaterial(), this, this._shouldConvertRHS(), subMesh.getMaterial()?.fillMode === Constants.MATERIAL_TriangleStripDrawMode);
        return this;
    }
    /**
     * @internal
