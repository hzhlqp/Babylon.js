 ...
 * The byte type.
 */
VertexBuffer.BYTE = Constants.BYTE;
/**
 * The unsigned byte type.
 */
VertexBuffer.UNSIGNED_BYTE = Constants.UNSIGNED_BYTE;
/**
 * The short type.
 */
VertexBuffer.SHORT = Constants.SHORT;
/**
 * The unsigned short type.
 */
VertexBuffer.UNSIGNED_SHORT = Constants.UNSIGNED_SHORT;
/**
 * The integer type.
 */
VertexBuffer.INT = Constants.INT;
/**
 * The unsigned integer type.
 */
VertexBuffer.UNSIGNED_INT = Constants.UNSIGNED_INT;
/**
 * The float type.
 */
VertexBuffer.FLOAT = Constants.FLOAT;
// Enums
/**
 * Positions
 */
VertexBuffer.PositionKind = Constants.PositionKind;
/**
 * Normals
 */
VertexBuffer.NormalKind = Constants.NormalKind;
/**
 * Tangents
 */
VertexBuffer.TangentKind = Constants.TangentKind;
/**
 * Texture coordinates
 */
VertexBuffer.UVKind = Constants.UVKind;
/**
 * Texture coordinates 2
 */
VertexBuffer.UV2Kind = Constants.UV2Kind;
/**
 * Texture coordinates 3
 */
VertexBuffer.UV3Kind = Constants.UV3Kind;
/**
 * Texture coordinates 4
 */
VertexBuffer.UV4Kind = Constants.UV4Kind;
/**
 * Texture coordinates 5
 */
VertexBuffer.UV5Kind = Constants.UV5Kind;
/**
 * Texture coordinates 6
 */
VertexBuffer.UV6Kind = Constants.UV6Kind;
/**
 * Colors
 */
VertexBuffer.ColorKind = Constants.ColorKind;
/**
 * Instance Colors
 */
VertexBuffer.ColorInstanceKind = Constants.ColorInstanceKind;
/**
 * Matrix indices (for bones)
 */
VertexBuffer.MatricesIndicesKind = Constants.MatricesIndicesKind;
/**
 * Matrix weights (for bones)
 */
VertexBuffer.MatricesWeightsKind = Constants.MatricesWeightsKind;
/**
 * Additional matrix indices (for bones)
 */
VertexBuffer.MatricesIndicesExtraKind = Constants.MatricesIndicesExtraKind;
/**
 * Additional matrix weights (for bones)
 */
VertexBuffer.MatricesWeightsExtraKind = Constants.MatricesWeightsExtraKind;
