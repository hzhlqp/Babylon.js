...
export class RGBDTextureTools {
    ...
    static ExpandRGBDTexture(texture) {
        ...
        const expandRGBDTexture = async () => {
            ...
            const rgbdPostProcess = new PostProcess("rgbdDecode", "rgbdDecode", null, null, 1, null, Constants.TEXTURE_TRILINEAR_SAMPLINGMODE, engine, false, undefined, internalTexture.type, undefined, null, false, undefined, shaderLanguage);
     ...
     */
    static EncodeTextureToRGBD(internalTexture, scene, outputTextureType = Constants.TEXTURETYPE_UNSIGNED_BYTE) {
