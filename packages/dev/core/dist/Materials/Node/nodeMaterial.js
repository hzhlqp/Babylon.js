...
export class NodeMaterial extends PushMaterial {
     ...
     */
    createPostProcess(camera, options = 1, samplingMode = Constants.TEXTURE_NEAREST_SAMPLINGMODE, engine, reusable, textureType = Constants.TEXTURETYPE_UNSIGNED_INT, textureFormat = Constants.TEXTUREFORMAT_RGBA) {
    ...
    _createEffectForPostProcess(postProcess, camera, options = 1, samplingMode = Constants.TEXTURE_NEAREST_SAMPLINGMODE, engine, reusable, textureType = Constants.TEXTURETYPE_UNSIGNED_INT, textureFormat = Constants.TEXTUREFORMAT_RGBA) {
...
NodeMaterial.SnippetUrl = Constants.SnippetUrl;
