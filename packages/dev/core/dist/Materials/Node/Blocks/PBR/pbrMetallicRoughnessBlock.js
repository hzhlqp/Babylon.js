...
import { BindLight, BindLights, PrepareDefinesForLight, PrepareDefinesForLights, PrepareDefinesForMultiview, PrepareUniformsAndSamplersForLight, } from "../../../materialHelper.functions";
...
export class PBRMetallicRoughnessBlock extends NodeMaterialBlock {
    ...
    constructor(name) {
         ...
         */
        this.realTimeFilteringQuality = Constants.TEXTURE_FILTERING_QUALITY_LOW;
        /**
