...
export class MirrorTexture extends RenderTargetTexture {
     ...
     */
    constructor(name, size, scene, generateMipMaps, type = Constants.TEXTURETYPE_UNSIGNED_INT, samplingMode = Texture.BILINEAR_SAMPLINGMODE, generateDepthBuffer = true) {
