...
export class EquiRectangularCubeTexture extends BaseTexture {
    ...
    _loadImage(loadTextureCallback, onError) {
        ...
        const texture = scene
            .getEngine()
            .createRawCubeTexture(null, this._size, Constants.TEXTUREFORMAT_RGB, scene.getEngine().getCaps().textureFloat ? Constants.TEXTURETYPE_FLOAT : Constants.TEXTURETYPE_UNSIGNED_INTEGER, !this._noMipmap, false, Constants.TEXTURE_TRILINEAR_SAMPLINGMODE);
