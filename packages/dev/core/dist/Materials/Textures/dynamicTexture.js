...
export class DynamicTexture extends Texture {
    /** @internal */
    constructor(name, canvasOrSize, sceneOrOptions, generateMipMaps = false, samplingMode = Constants.TEXTURE_TRILINEAR_SAMPLINGMODE, format = Constants.TEXTUREFORMAT_RGBA, invertY) {
